	...
	<header>
		...
		<div class="menu">
			<ul>
				...
				<li class="menu-item hidden">
					<a href="https://github.com/codeigniter4/CodeIgniter4/blob/master/CONTRIBUTING.md" target="_blank">Contribute</a>
				</li>
			</ul>
		</div>
		<div class="heroe">
	...
	<div class="further">
		<section>
			...
			<p>
				...
				the threads on
				<a href="https://forum.codeigniter.com/" target="_blank">CodeIgniter's forum</a>,
				or
